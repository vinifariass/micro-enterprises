        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div>
            <div className="grid grid-cols-6 gap-4">
              <div className="hidden lg:flex lg:flex-col gap-3 col-span-1">
                {gallery.map((src, i) => (
                  <button
                    ...
                    onClick={() => setActive(i)}
                    className={
                      "relative aspect-square rounded border overflow-hidden bg-white " +
              ...
              <div className="col-span-6 lg:col-span-5">
                <div
                  className={
                    (isShoe ? "aspect-[4/3]" : "aspect-[1]") +
                    " bg-white rounded-lg overflow-hidden border grid place-items-center"
                  }
                >
                  {gallery[active] && (
                    <Image
          ...
          <div>
            ...
            <div className="mt-1 text-sm text-gray-500">
              ★★★★★ <span className="align-middle">(2 avaliações)</span>
            </div>
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {SIZES.map((s) => (
                  <button
                    key={s}
                    onClick={() => setSize(s)}
                    className={(size === s ? "bg-black text-white " : "") + "px-3 py-2 rounded-full border text-sm"}
                  >
                    {s}
                  </button>
                ))}
