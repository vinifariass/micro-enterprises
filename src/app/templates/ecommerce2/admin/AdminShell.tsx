...
function AdminLayoutFrame({ children }: { children: React.ReactNode }) {
  ...
  const sidebarWidth = sidebar?.collapsed ? "72px" : "256px";

  return (
    <div
      className="min-h-screen bg-slate-50 text-slate-900 transition-[padding-left] duration-300 md:pl-[var(--sidebar-width)]"
